...
const positions = [
    ...
    "Contador", // PosiciÃ³n de defensa central
    "Cartera", // PosiciÃ³n de lateral derecho
    "Ingeniero de sistemas", // PosiciÃ³n de lateral izquierdo
    "Soporte tecnico", // PosiciÃ³n de mediocampista defensivo
    "Marketing", // PosiciÃ³n de mediocampista ofensivo
    "Logista", // PosiciÃ³n de extremo derecho
    "Bodega", // PosiciÃ³n de extremo izquierdo
    "Ventas" // PosiciÃ³n de delantero centro
];
...
function updateTeamSelect() {
    ...
    teamSelect.innerHTML = `<option value="">Seleccione una Empresa</option>`; // Agrega la opciÃ³n predeterminada
    teams.forEach(team => {
        const option = document.createElement("option"); // Crea un elemento de opciÃ³n
